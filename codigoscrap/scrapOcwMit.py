...
for cont,x in enumerate(datos):
    if cont<0:
        continue
    urlscrap=x[0]
    urlscrap='http://ocw.mit.edu/courses/urban-studies-and-planning/11-481j-analyzing-and-accounting-for-regional-economic-growth-spring-2009'
    ...
    for i in tiSoup:
        ...
        for href in hrefs:
            ...
            if str(aux)[0]=='<':
                ...
                htmlOer=aux.parent
                descripOer=removersignos(aux)#aux
                #print '   %s'%descripOer
            ...
            #ObjBd.insertar_datos_trip(urlMenu,'rdf:type','oer',tabla)
            #ObjBd.insertar_datos_trip(urlMenu,'rdf:type',extoer,tabla)
