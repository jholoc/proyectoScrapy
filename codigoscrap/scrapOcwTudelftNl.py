...
for cont,x in enumerate(datos):
    ...
    tiSoup = soup1.select("div#contentMenu > ul > li > ul > li")#selecion de la pagina que contiene los titulos de las noticias
    ...
    for i in tiSoup:
        ...
        htmlCurso = soup2.select('#contentText')#html del curso
