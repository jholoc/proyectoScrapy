...
for cont,x in enumerate(datos):
    ...
    tiSoup = soup1.select("ul.course_categories > li.category")#selecion de la pagina que contiene los titulos de las noticias
    ...
    for i in tiSoup:
        ...
        htmlCurso = soup2.select('div.right_course')#html del curso
