...
urlscrap='http://ocw.uoc.edu/informacio-i-comunicacio/tecniques-de-gestio-i-comunicacio'

webpage1 = urlopen(urlscrap).read() #lectura de la pagina a scrapear
    
soup1 = BeautifulSoup(webpage1)
#print soup1
tiSoup = soup1.select(".unSelected")#selecion de la pagina que contiene los titulos de las noticias
#print "sadsa"
#print tiSoup
for i in tiSoup:
    print i.a.text
    ...
    for href in hrefs:
    	...
    	if len(aux)<4:
    		#print 'PEQUEÑO'
    		aux=aux.previous_element.previous_element
        """while len(str(aux))<4:
            print 'AQIIIII'
